...
BEACON files originated in the German Wikpedia due to the need to share links between
Wikipedia articles and related resources on the web using identifiers from the authority file
...
- This `page in the German Wikipedia <https://de.wikipedia.org/wiki/Wikipedia:BEACON>`_ is the most complete list of available BEACON files on the web (up to now)
